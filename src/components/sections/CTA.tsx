  ...
  return (
    <div ref={containerRef} className="relative w-full bg-white select-none overflow-hidden">
      ...
      >
        ...
        <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-10 flex items-center justify-center pointer-events-auto cursor-pointer">
          <motion.div
            style={{
              y: logoY,
            }}
        ...
        {/* Top-Left Title (Matching Reference Image in Two Lines) */}
        <div className="relative z-20 pointer-events-none">
          <motion.h2
            ...
            className="font-sora font-semibold text-3xl sm:text-5xl md:text-[56px] lg:text-[64px] leading-[1.1] tracking-tight bg-clip-text text-transparent max-w-xl pointer-events-auto"
          >
            Let's Build
            <br />
        ...
        {/* Bottom Bar: Bottom-Left Description & Bottom-Right Button (Matching Reference Image) */}
        <div className="relative z-20 flex flex-col sm:flex-row items-start sm:items-end justify-between gap-6 w-full pointer-events-none pt-12">
          {/* Bottom-Left Description (White Text) */}
          <motion.p
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.7, delay: 0.1 }}
            className="text-white text-sm sm:text-base md:text-[17px] font-light leading-relaxed max-w-sm pointer-events-auto"
          >
